...
void Sandbox2D::OnUpdate(Hazel::Timestep ts)
{
	...
	}
	{
		...
		Hazel::Renderer2D::DrawRotatedQuad({ -1.0f, 0.0f }, {0.8f, 0.8f}, glm::radians(22.5f + rotation), { 0.8f, 0.2f, 0.3f, 1.0f });
		Hazel::Renderer2D::DrawRotatedQuad({ -1.0f, 0.0f }, {0.8f, 0.8f}, glm::radians(-22.5f + rotation), { 0.8f, 0.2f, 0.3f, 1.0f });
		Hazel::Renderer2D::DrawQuad({ 0.5f, -0.5f }, { 0.5f, 0.75f }, { 0.2f, 0.3f, 0.8f, 1.0f });
		Hazel::Renderer2D::DrawQuad({ -5.0f, -5.0f, -0.05f}, { 10.0f, 10.0f }, m_CheckerboardTexture, 10.0f);
		Hazel::Renderer2D::DrawRotatedQuad({ -0.5f, -0.5f, -0.01f }, { 1.0f, 1.0f }, glm::radians(45.0f), m_CheckerboardTexture, 20.0f);
		Hazel::Renderer2D::DrawRotatedQuad({ -0.0f, -0.0f, -0.1f }, { 10.0f, 10.0f }, glm::radians(45.0f), m_CheckerboardTexture, 10.0f);
		...
		//Hazel::Renderer2D::DrawQuad({ -1.0f, 0.5f, 0.5f }, { 1.0f, 2.0f }, m_TextureTree);
		Hazel::Renderer2D::EndScene();
	}
}
