...
#define HZ_ADD_INTERNAL_CALL(Name) mono_add_internal_call("Hazel.InternalCalls::" #Name, Name)
	...
	static void NativeLog_Vector3(glm::vec3* paramter, glm::vec3* outResult)
	{
		HZ_CORE_WARN("Value: {0}", *paramter);

		*outResult = glm::normalize(*paramter);
	}

	static float NativeLog_Vector3Dot(glm::vec3* paramter)
	{
