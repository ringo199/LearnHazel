...
namespace Hazel
{
	...
	void ScriptEngine::Init()
	{
		...
		MonoMethod* PrintCustemMessageFunc = s_Data->EntityClass.GetMethod("PrintCustumMessage", 1);

		void* stringParam = monoString;
		s_Data->EntityClass.InvokeMethod(instance, PrintCustemMessageFunc, &stringParam);
#endif
	}
